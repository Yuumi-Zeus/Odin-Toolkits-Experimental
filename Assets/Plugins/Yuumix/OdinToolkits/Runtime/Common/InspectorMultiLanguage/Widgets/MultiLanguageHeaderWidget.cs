...
namespace Yuumix.OdinToolkits.Common
{
    ...
    public class MultiLanguageHeaderWidget
    {
        ...
        [PropertySpace(5)]
        [MultiLanguageButtonWidgetConfig("中文", "English", buttonHeight: 22,
        ...
        [PropertySpace(2, 5)]
        [ShowIfChinese]
        [Button("文档", ButtonHeight = 22, Icon = SdfIconType.Link45deg)]
        ...
        {
            InspectorMultiLanguageManagerSO manager = InspectorMultiLanguageManagerSO.Instance;
        ...
        {
            string validatedUrl = UrlUtil.ValidateAndNormalizeUrl(targetUrl, UrlUtil.OdinToolkitsDocsUrl);
